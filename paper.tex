...
We also implement an approach to detect differentially methylated regions (DMRs) between groups of cells, and demonstrate its ability to detect biologically meaningful regions near genes involved in core functions of specific cell types.
