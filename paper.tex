...
To enable a more targeted characterization of 
The same principles may also be applied to DMRs, thus enabling in-depth characterization of epigenomic and gene regulatory differences between tissues, cell types or conditions.
...
\phantomsection
\subsection{Correlation of VMR methylation with gene expression}

The first data set used to test our methods is a single-cell multi-omics data set generated by \citet{kremer_scnmt}.
This data set comprises the methylomes of 1566 cells isolated from mouse forebrains, as well as single-cell transcriptomes of the same cells.
