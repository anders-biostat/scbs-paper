...
To facilitate the analysis of scBS data, we have developed a software tool called "\textttt{scbs}" that implements these methods and provides additional functionality.
