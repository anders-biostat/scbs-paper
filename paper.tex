...
\new{
Methylation was then quantified in four sets of genomic intervals:
...
non-overlapping tiles of 100~kb width;
...
Averaged m}ethylation fractions and the shrunken means of residuals were quantified with \texttt{scbs matrix} \new{for all four sets of regions}.
...
\todo{fix: For each data set, we thus obtained four methylation matrices:
...
\begin{minipage}{\linewidth}
	...
	\todo{Analysing this large data set took approximately XXX hours and required approximately XXX GB of RAM. (Sveta, pls give some rough estimate here)}
	}}
	\label{fig:umaps}
\end{minipage}
