...
\new{To assess whether our proposed methods are also suitable for the analysis of CH-methylation, we furthermore performed VMR detection with default options on the mCH-portion of this data set.}
...
\begin{minipage}{\linewidth}
	\begin{center}
		\includegraphics[width=.8\textwidth]{figures/SFig_benchmark_resources.png}
	\end{center}
	\captionof{figure}{\small \new{\textbf{VMRs are as informative as regulatory regions, but more resource-efficient.}\\
	\textbf{(A-B)} Mean neighbor score obtained when quantifying CpG methylation at VMRs, all ENCODE regulatory regions, or a subset of regulatory regions.
