...
Lukas P.~M. Kremer, Leonie Küchenhoff, Santiago Cerrizuela, ..., Ana Martin-Villalba, Simon Anders\\
...
\begin{figure}
	...
	\caption{\small \textbf{Overview of the functionalities implemented in the scbs package} Bla bla.}
	\label{workflow}
\end{figure}

We have implemented the approach just described in a Python package, called ``scbs'', that offers the following functionality \ref{workflow}:
