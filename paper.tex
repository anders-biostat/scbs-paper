...
The first data set is a single-cell multi-omic data set generated by \citet{argelaguet2019gastru}. In their work, the authors obtained single-cell methylomes of mouse embryo cells across different stages of development (E4.5 – E7.5), as well as single-cell transcriptomes from the same cells. They calculated the correlation between RNA expression and DNA methylation at the corresponding promoter region to elucidate the implications of the epigenome on gene expression in development. \citet{argelaguet2019gastru} defined promoters as genomic intervals \textpm2~kb around the TSS of each gene. 
