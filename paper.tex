...
\small
\textit{Abstract} -- Single-cell bisulfite sequencing (scBS) is a technique that enables the assessment of DNA methylation at single-base pair and single-cell resolution.
However, the analysis of the large datasets obtained from scBS requires preprocessing to reduce data size, improve signal-to-noise ratio, and provide interpretability.
...
\begin{minipage}{\linewidth}
	\begin{center}
	    \includegraphics[width=0.6\textwidth]{figures/SFig_benchmark.png}
	\end{center}
