...
\new{VMRs that intersect protein-coding gene bodies, CpG islands or cCREs were quantified by subtracting VMRs with at least one bp of overlap using \texttt{bedtools} \texttt{subtract} \texttt{-A} \citep{quinlan2010bedtools}.
}
