...
\begin{figure*}[t]
    ...
    Tiles or VMRs were pre-processed as proposed in this work (shrunken mean of residuals subjected to iterative PCA, labeled "pre-processing: ours") or using conventional methods (PCA on lightly imputed methylation percentages, based on \citet{luo2017single}).
...
L.\ P.\ M.\ K., M.\ B., L.\ K., S.\ C.\ and A.\ M.-V.\ acknowledge funding from the European Commission via ERC grant 771376.
