...
\begin{minipage}{\linewidth}
	...
	\end{center}
	\captionof{figure}{\small \new{\textbf{VMRs are more informative than an equal number of regulatory regions with high sequencing coverage.}\\
...
\begin{minipage}{\linewidth}
	...
	\new{Analysing this large data set takes approximately a week on a computer with 256 GB RAM and 48 CPUs, with almost all of this time (152 hours) spent by the \texttt{prepare} step, which is run only once per data set. The speed of this step can be increased considerably by processing chromosomes in parallel, which reduced the total runtime to approximately two days in our case.}
	}}
	\label{fig:umaps}
\end{minipage}
