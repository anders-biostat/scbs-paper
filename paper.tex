...
Fig.~\ref{fig:dmr}D-E depicts an exemplary DMR, located at the gene body of myelin-basic protein (\textit{Mbp}), the major component of myelin that is essential for myelination of neuronal axons \citep{mbp}.
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[width=.7\columnwidth]{figures/Fig_sliding.png}
	\end{center}
